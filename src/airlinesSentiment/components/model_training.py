...
from airlinesSentiment.entity.config_entity import TrainingConfig
...
class ModelTraining:
    ...
    def load_datasets(self):
        """ 
        Loads the train, validation, and test datasets from specified directory
        
        """

        #Explicitly the correct path
    ...
    def evaluate(self):
        ...
        logger.info(f"    - Loss: {results['eval_runtime']:.2f} seconds")
